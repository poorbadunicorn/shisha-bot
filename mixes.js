...
// ==== БАЗА ВКУСОВ (для конфигуратора: автоопределение профиля) ====
// profile: sour | sweet | sourSweet | neutral | fresh | spicy | dessert
window.FLAVOR_DB = {
  // сладкие фрукты
  "арбуз":"sweet","дыня":"sweet","персик":"sweet","манго":"sweet","груша":"sweet",
  "банан":"sweet","ананас":"sourSweet","виноград":"sweet","клубника":"sweet","земляника":"sweet",
  "яблоко":"sweet","дюшес":"sweet","тархун":"fresh","личи":"sweet","инжир":"sweet",
  "хурма":"sweet","абрикос":"sweet","нектарин":"sweet","папайя":"sweet",
  // ягоды / кисло-сладкие
  "малина":"sourSweet","вишня":"sourSweet","черешня":"sourSweet","ежевика":"sourSweet",
  "клюква":"sour","брусника":"sour","облепиха":"sour","гранат":"sour","смородина":"sour",
  "черника":"sweet","голубика":"sweet","земляничный":"sweet","маракуйя":"sourSweet",
  "киви":"sourSweet","фейхоа":"sour","годжи":"sourSweet",
  // цитрус / кислые
  "лимон":"sour","лайм":"sour","грейпфрут":"sour","апельсин":"sourSweet","мандарин":"sourSweet",
  "цитрус":"sour","бергамот":"neutral","помело":"sour","юдзу":"sour",
  // свежесть
  "мята":"fresh","ментол":"fresh","лёд":"fresh","лед":"fresh","холодок":"fresh",
  "эвкалипт":"fresh","айс":"fresh","ice":"fresh","mint":"fresh","огурец":"fresh","базилик":"fresh",
  // десерты / кремовые
  "ваниль":"dessert","сливки":"dessert","чизкейк":"dessert","йогурт":"dessert","крем":"dessert",
  "шоколад":"dessert","какао":"dessert","кофе":"dessert","карамель":"dessert","печенье":"dessert",
  "мороженое":"dessert","пломбир":"dessert","халва":"dessert","кокос":"dessert","орех":"dessert",
  "мёд":"sweet","мед":"sweet","сгущёнка":"dessert","сгущенка":"dessert","пряник":"dessert",
  // пряности
  "корица":"spicy","гвоздика":"spicy","имбирь":"spicy","перец":"spicy","анис":"spicy",
  "кардамон":"spicy","мускат":"spicy","бадьян":"spicy","специи":"spicy",
  // нейтральные / прочее
  "чай":"neutral","зелёный чай":"neutral","зеленый чай":"neutral","чёрный чай":"neutral",
  "жасмин":"neutral","роза":"neutral","лаванда":"neutral","кола":"sweet","байкал":"neutral",
  "табак":"neutral","виски":"neutral","ром":"neutral","мохито":"fresh","пина колада":"dessert",
  "барбарис":"sourSweet","саусеп":"sourSweet","гуава":"sweet"
};

// ==== БРЕНДЫ: крепость (tier) и тип листа (dark = тёмный, нужен меньший жар) ====
window.BRANDS = {
  "Element Вода":{tier:"light",dark:false}, "Element Воздух":{tier:"light",dark:false},
  "Element Земля":{tier:"medium",dark:false}, "MustHave":{tier:"medium",dark:false},
  "Sebero":{tier:"medium",dark:false}, "Darkside Base":{tier:"medium",dark:true},
  "Darkside Core":{tier:"strong",dark:true}, "Tangiers Noir":{tier:"strong",dark:true},
  "Overdose":{tier:"strong",dark:true}, "Bonche":{tier:"strong",dark:true},
  "Blackburn":{tier:"strong",dark:true}, "Хулиган":{tier:"strong",dark:true},
  "Satyr":{tier:"strong",dark:true}, "Daily Hookah":{tier:"light",dark:false},
  "Наш":{tier:"medium",dark:false}, "Трофимов":{tier:"medium",dark:false},
  "Северный":{tier:"medium",dark:false}, "Богатырь":{tier:"medium",dark:false},
  "Chabacco Medium":{tier:"medium",dark:false}, "Afzal":{tier:"medium",dark:false},
  "Al Fakher":{tier:"light",dark:false}, "Serbetli":{tier:"light",dark:false},
  "Adalya":{tier:"light",dark:false},
  // дополнительные бренды для вариантов замены
  "Fumari":{tier:"light",dark:false}, "Starbuzz":{tier:"medium",dark:false},
  "WTO":{tier:"strong",dark:true}, "Duft":{tier:"strong",dark:true}
};
window.TIER_LABEL = { light:"лёгкий", medium:"средний", strong:"крепкий" };

// семейства вкусов (по подстрокам названия)
window.FAMILIES = {
  "ягода":["малин","смородин","вишн","черешн","клубник","земляник","черник","голубик","ежевик","брусник","клюкв","облепих","барбарис","гранат","годж","ягод","raspberry","cherry","currant","strawberry","blueberry","pomegranate","barberry","berry"],
  "цитрус":["лимон","лайм","грейпфрут","апельсин","мандарин","цитрус","помело","юдзу","бергам","lemon","lime","grapefruit","orange","citrus","bergam"],
  "дыняарбуз":["арбуз","дын","watermelon","melon"],
  "тропик":["манго","маракуй","ананас","личи","папай","гуав","персик","киви","абрикос","нектарин","саусеп","фейхоа","passion","mango","peach","pineapple","lychee","kiwi","guava","cantaloupe","tropic"],
  "виноград":["виноград","grape"],
  "яблокогруша":["яблок","груш","дюшес","айва","apple","pear"],
  "свежесть":["мят","лёд","лед ","ментол","холодок","эвкалипт","айс","ice","mint","needl","supernova","cool","fresh"],
  "десерт":["ваниль","сливк","чизкейк","йогурт","крем","шоколад","какао","кофе","карамель","печень","мороже","пломбир","халв","кокос","орех","мёд","мед","сгущ","пряник","cocoa","coffee","honey","cream","vanilla","cheesecake","coconut","nut"],
  "пряность":["кориц","гвоздик","имбир","анис","кардамон","мускат","бадьян","специ","перец","cinnam","anise"],
  "чайцветы":["чай","жасмин","роз","лаванд","тархун","earl","tea","jasmine","rose"],
  "напиток":["кола","cola","байкал","виски","whisky","ром","мохито","лимонад","lemonad","mojito"]
};

// какие семейства каждый бренд уверенно делает (иначе — базовый набор фруктов)
window.BRAND_COVERS = {
  "Element Вода":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","напиток"],
  "Element Земля":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","десерт","пряность","чайцветы","напиток"],
  "Tangiers Noir":["цитрус","тропик","дыняарбуз","виноград","десерт","пряность","чайцветы","напиток"],
  "Darkside Core":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","чайцветы","пряность","напиток"],
  "Darkside Base":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","чайцветы","напиток"],
  "MustHave":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","напиток"],
  "Daily Hookah":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","чайцветы","пряность","напиток"],
  "Satyr":["десерт","пряность","чайцветы","ягода","напиток","тропик"],
  "Северный":["ягода","десерт","чайцветы","пряность","яблокогруша","напиток","дыняарбуз"],
  "Sebero":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","напиток"],
  "Fumari":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","пряность","чайцветы","напиток"],
  "Adalya":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","напиток"],
  "Serbetli":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","напиток"],
  "Al Fakher":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","напиток"],
  "Bonche":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","напиток"],
  "Богатырь":["ягода","цитрус","дыняарбуз","тропик","виноград","яблокогруша","свежесть","десерт","чайцветы","напиток"]
};
